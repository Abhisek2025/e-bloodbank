...
const LabManageRequests = () => {
  ...
  const loadRequests = async () => {
    try {
      ...
      const res = await axios.get("https://bbms-webserver.onrender.com/api/blood-lab/blood/requests", {
  ...
  const updateStatus = async (id, action) => {
    try {
      ...
      await axios.put(
        `https://bbms-webserver.onrender.com/api/blood-lab/blood/requests/${id}`,
        { action },
        { headers: { Authorization: `Bearer ${token}` } }
      );
